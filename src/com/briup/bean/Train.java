...
public class Train implements Serializable {
    ...
    public Train(int train_id, int type_code, TrainType trainType, Staff staff, Date train_btime, Date train_etime, String train_expense, int p_id, String type_name) {
