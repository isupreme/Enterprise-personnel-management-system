        ...
        <div class="col-md-12 column">
            ...
            <div class="form-group container" style="">
                ...
                <button type="submit" style="float: right"
                        class=" btn btn-default col-sm-1" id="LikeSearch">查询
                </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger"
                                    data-dismiss="modal" id="delete-ok">确定
                            </button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row" style="margin-top: 26px; padding-right: 0px;">
                                    <label for="TypeCode" class="col-sm-2 control-label"
                                           style="padding-right: 0;">培训项目编号：</label>
            ...
            <table class="table table-hover table-condensed">
                <thead>
                <tr>
                    <th class="text-center">培训项目编号</th>
                            ...
                            $.ajax({
                                ...
                                success: function (
                                    ...
                                    if (data.status == 200) {
                                        ...
                                        alert("新增培训出现了问题：请确定不存在输入ID的培训项目");
                                    }
                                }
                            });
                        }
