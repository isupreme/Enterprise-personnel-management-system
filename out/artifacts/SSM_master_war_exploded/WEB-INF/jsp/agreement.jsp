            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < agr.length; i++) {
                        ...
                        $template.children('td').eq(3).append("<a href='file/"+agr[i].agreement_content +"' target='_blank'><img src='images/word.png' ></img></a>");
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    for (var i = 0; i < agr.length; i++) {
                                        ...
                                        // $template.children('td').eq(3).append("<a href='download/file?fileName="+agr[i].agreement_content +"' target='_self'><img src='images/word.png'></img></a>");
                                        $template.children('td').eq(3).append("<a href='file/"+agr[i].agreement_content +"' target='_blank'><img src='images/word.png'></img></a>");
                                        var $btnGroup = $template.children('td').eq(4).find('button');
                                        if (C!=2){
                                            $btnGroup.hide();$template.children('td').eq(2).text(agr[i].agreement_btime);
                                        }
                                        $btnGroup.eq(0).attr('name', agr[i].agreement_id);
                                        $btnGroup.eq(1).attr('name', agr[i].agreement_id);
                                        $table.append($template);
                    ...
                    $("#insertAgr").click(function () {
                      ...
                      // 接收上传文件的后台地址
                         $.ajax({
                                 ...
                                 data: form,
                                 error: function (error) {
                                     alert("新增合同出现了问题error：" + error.status+"请确定该员工存在并且没有签署合同");
                                 },
                                 success: function (data) {
                                     if (data.status == 200) {
 									      alert("添加合同成功");
...
<%--                                <label for="agreement" class="col-sm-4  control-label ">合同内容：</label>--%>
                                <label for="textfield" class="col-sm-4  control-label ">合同内容：</label>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="height: 270px;">
                            <div class="form-group">
                                <div class="row">
                                    <label for="textfield2" class="col-sm-4  control-label ">合同内容：</label>
                                     <div class="col-sm-8 col-sm-pull-2">
                                ...
                                <div class="row" style="margin-top: 26px; padding-right: 0px;">
                                    <label for="StaffId2" class="col-sm-2 control-label" style="padding-right: 0;">合同编号：</label>
                                    <div class="input-group col-sm-5 ">
                                        <input class="form-control col-sm-4 " id="StaffId2" type="StaffId2" />
                                    </div>
                                </div>
                               <!--  <div class="row" style="margin-top: 26px; padding-right: 0px;">
